...
* **scan-rust:** change pkg ([24b56fc](https://github.com/Kong/public-shared-actions/commit/24b56fc135e0ae5be9a170041a1e572bcde83e36))
* **scan-rust:** update package name ([8050d0f](https://github.com/Kong/public-shared-actions/commit/8050d0fea85fef043fcbc75eb8ee0d8966989970))
* **security-actions-scan-rust:** update pkg ([585a397](https://github.com/Kong/public-shared-actions/commit/585a3970af34d3168f2e843f79e4ea174199103b))
...
* **security-actions-scan-rust:** `extends` key in config file is now used for extending other config files
* **scan-rust:** `extends` key in config file is now used for extending other config files
